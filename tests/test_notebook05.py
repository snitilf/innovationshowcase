...
try:
    ...
    print(f"   ✓ main dataset: {main_data_path}")
    ...
    print(f"   ✓ all 6 governance indicators present")
    print(f"   ✓ no missing values in governance indicators\n")
    ...
    print(f"   ✓ all 5 economic indicators present")
    ...
    print(f"   ✓ final training data: {final_df.shape[0]} rows, {final_df.shape[1]} columns")
    ...
    print(f"   ✓ sentiment merged and missing values filled\n")
    ...
    print(f"   ✓ loaded {len(predictive_features)} predictive features from feature_names.txt")
    ...
    print(f"   ✓ predictive features correctly defined:")
    ...
    if not (0.75 <= train_pct <= 0.85):
        ...
        print(f"   ✓ train/test split: {train_pct:.1%}/{test_pct:.1%}")
    ...
    print(f"   ✓ all predictive features and target variable present\n")
    ...
    if train_diff > 0.05 or test_diff > 0.05:
        ...
        print(f"   ✓ class balance maintained in train/test splits\n")
    ...
    print(f"   ✓ no missing values in train set features")
    print(f"   ✓ no missing values in test set features\n")
    ...
    if 'sentiment_score' in train_X.columns:
        ...
        if sent_min < -1.1 or sent_max > 1.1:
            ...
            print(f"   ✓ sentiment_score in valid range: [{sent_min:.4f}, {sent_max:.4f}]")
    ...
    if country_count != 19:
        ...
        print(f"   ✓ {country_count} countries present\n")
    ...
    if len(malaysia_scandal) == 0:
        ...
        if not malaysia_scandal['corruption_risk'].all():
            ...
            print(f"   ✓ malaysia 1mdb (2013-2015): {len(malaysia_scandal)} records, all high risk")
    ...
    if len(mozambique_scandal) == 0:
        ...
        if not mozambique_scandal['corruption_risk'].all():
            ...
            print(f"   ✓ mozambique hidden debt (2013-2016): {len(mozambique_scandal)} records, all high risk")
    ...
    if len(canada) == 0:
        ...
        if canada_high_risk > 0:
            ...
            print(f"   ✓ canada (control): {len(canada)} records, all low risk")
    ...
    if len(X_train_recreated) != len(train_df) or len(X_test_recreated) != len(test_df):
        ...
        print(f"   ✓ train/test split is reproducible (random_state=42)\n")
    
    # 18. summary validation
    print("18. validation summary...")
    print("   ✓ all required input files present")
    print("   ✓ governance indicators present (validation features)")
    print("   ✓ economic indicators present (predictive features)")
    print("   ✓ sentiment scores merged correctly")
    print("   ✓ predictive features correctly defined (6 features: 5 economic + 1 sentiment)")
    print("   ✓ governance indicators excluded from predictive features")
    print("   ✓ train/test split files created")
    print("   ✓ stratified split maintains class balance")
    print("   ✓ no missing values in predictive features")
    print("   ✓ feature ranges are reasonable")
    print("   ✓ no duplicate country-year combinations")
    print("   ✓ year range is correct (2010-2023)")
    print("   ✓ case study countries present with correct labels")
    print("   ✓ target variable has both classes")
    print("   ✓ train/test split is reproducible\n")
